const translations = {
  es: {
    ...
    "exp.desc.servicedesk": "Soporte técnico crítico (Nivel 1/2) e infraestructura física y cloud en entornos de alta demanda. Administración de identidades con <strong>Google Workspace</strong>, gestión de escritorios virtuales en <strong>Citrix Workspace</strong> y protección endpoint con <strong>Bitdefender</strong>. Gestión integral del parque de dispositivos macOS mediante <strong>JAMF Cloud</strong> y <strong>Apple Business Manager</strong>, garantizando el cumplimiento de políticas de seguridad. Liderazgo técnico en proyectos de expansión para nuevos centros, coordinando el despliegue de CPDs, redes cloud <strong>Extreme Networks</strong> y telefonía <strong>AVAYA</strong>, asegurando una resolución eficiente de incidencias bajo metodologías ágiles a través de <strong>JIRA</strong>.",
  ...
  en: {
    ...
    "exp.desc.servicedesk": "Critical technical support (L1/L2) and physical/cloud infrastructure management in high-demand environments. Identity administration with <strong>Google Workspace</strong>, virtual desktop management in <strong>Citrix Workspace</strong>, and endpoint protection with <strong>Bitdefender</strong>. Comprehensive management of the macOS device fleet via <strong>JAMF Cloud</strong> and <strong>Apple Business Manager</strong>, ensuring compliance with security policies. Technical leadership in expansion projects for new centers, coordinating the deployment of datacenters, <strong>Extreme Networks</strong> cloud networks, and <strong>AVAYA</strong> telephony, ensuring efficient incident resolution under agile methodologies via <strong>JIRA</strong>.",
